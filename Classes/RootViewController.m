...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    Patients *managedObject = [fetchedResultsController objectAtIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        Patients *objectToDelete = [fetchedResultsController objectAtIndexPath:indexPath];
...
- (void)tableView:(UITableView *)aTableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Patients *selectedObject = [[self fetchedResultsController] objectAtIndexPath:indexPath];
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Patients" inManagedObjectContext:managedObjectContext];
